...
export const SamplesColumnInfo = [
  ...
  {name: 'org', displayText: 'Org', selected: true},
  ...
  {name: 'weight', displayText: 'weight', selected: true},
  {name: 'unit', displayText: 'Unit', selected: true},
  {name: 'price', displayText: 'Price', selected: true},
  {name: 'quantity', displayText: 'Quantity', selected: true},
  {name: 'batchCode', displayText: 'Batch Code', selected: true},
  {name: 'batchName', displayText: 'Batch Name', selected: true},
  {name: 'description', displayText: 'Description', selected: true},
  {name: 'qrCode', displayText: 'QR Code', selected: true},
];
